...
/**
 * ajax 용 security
 * debug -> FilterChainProxy class -> doFilter method 시작
...
//                .addFilterBefore(ajaxLoginProcessingFilter(), UsernamePasswordAuthenticationFilter.class)//기존의 필터 앞에 추가
        ...
        http
                .exceptionHandling()
                .authenticationEntryPoint(new AjaxLoginAuthenticationEntryPoint())//인증못받음
                .accessDeniedHandler(ajaxAccessDeniedHandler())//인가못받음
        ;
        http.csrf().disable();
